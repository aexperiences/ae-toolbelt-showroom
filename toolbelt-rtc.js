/* mca-rtc.js — Selkirk Mechanical (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.TOOLBELT_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.ToolbeltMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
